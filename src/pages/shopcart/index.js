...
function loadingToast() {
    Toast.loading("即将付款请稍后", 0.4, () => {});
}
function successToast() {
    Toast.success("付款成功", 0.8);
}
                                ...
                                <div key={index} className="shop-item">
                                    <div className="shop-items">
                                        ...
                                        <div className="shop-text">
                                            <span className="shop-desc">服务保障：{item.desc}</span>
                                            <br />
                                            <span className="shop-adress">发货地址：{item.adress}</span>
                                            <br />
                                            <span className="shop-oldPrice">原价：{item.oldPrice}</span>
                                            <br />
                                            <span className="shop-newPrice">现价：{item.nowPrice}</span>
                                            <br />
                                        </div>
                                    </div>
                                </div>
...
export default connect(state => ({ shopcart: state.shopcartArr }))(App);
